...
- Parsed-candidate save verified end to end in the live preview: Sarah Jacobs was extracted with Front Office Manager and cape town, Save candidate draft closed the parser, the Candidates view displayed Sarah Jacobs, and localStorage contained the saved candidate record with stage New and initials SJ.
- Parsed-candidate detail verification passed in the live preview: a persisted Sarah Jacobs record opened from Candidates via Edit Sarah Jacobs, and the edit modal contained Front Office Manager and cape town in its fields.
- Automated persistence regression coverage was added through the shared candidatePersistence contract; the suite now passes 9 tests, including case-insensitive duplicate replacement and New-stage record construction.
